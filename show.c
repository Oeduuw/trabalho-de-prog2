...
//função para gerenciar outras funções
void gerenciador()
{
    int nG;
        printf("-------------------------------------------------------\n"); 
...
void excluirShow() 
{
    ...
    do
    {
        ...
        printf("\n\n\t - Deseja excluir outro show? [S]im ou [N]ão: ");
        resp = getchar();
        getchar();
...
void alterarShow() 
{
    ...
    do
    {
        ...
        printf("\n\n\t - Deseja alterar outro show? [S]im ou [N]ão: ");
        resp = getchar();
        getchar();
...
void comprarIngresso()
{
    ...
    do
    {
        ...
        printf("\n\n\t - Deseja comprar outro ingresso? [S]im ou [N]ão: ");
        resp = getchar();
        getchar();
